...
class InitializeScannerEvent extends ScannerEvent {}

class StartScanEvent extends ScannerEvent {}

class PauseScanEvent extends ScannerEvent {}

class ResumeScanEvent extends ScannerEvent {}

class CompleteScanEvent extends ScannerEvent {}

class CancelScanEvent extends ScannerEvent {}

class UpdateProgressEvent extends ScannerEvent {
  final double progress;
  final String message;

  UpdateProgressEvent(this.progress, this.message);
}
